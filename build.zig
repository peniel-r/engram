...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "Engram" is the name you will use in your source code to
                // import this module (e.g. `@import("Engram")`). The name is
    ...
    // times and since two run steps do not depend on one another, this will
    // make two of them run in parallel.
    ...
    const int_mod = b.createModule(.{
        .root_source_file = b.path("tests/integration/alm_workflow.zig"),
        .target = target,
        .optimize = optimize,
        .imports = &.{
            .{ .name = "Engram", .module = mod },
